    ...
    saveJob: function () {
      ...
      */
      ...
      if ($("#on_off").is(":checked")){
        ...
        command_url = '/api/schedule/on_off_once';
        data = JSON.stringify({deviceId: devId,startTime:$('#job-schedule-startTime').val(),endTime:$('#job-schedule-endTime').val()});
      } else if ($("#on").is(":checked")){
        // alert('ligar');
        command_url = '/api/schedule/on_once';
        data = JSON.stringify({deviceId: devId,startTime:$('#job-schedule-startTime').val()});
      } else if ($("#off").is(":checked")){
        // alert('desligar');
        command_url = '/api/schedule/off_once';
        data = JSON.stringify({deviceId: devId,startTime:$('#job-schedule-startTime').val()});
      }
